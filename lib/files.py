...
class Files (Enum):
    pho = ["arw", "btf", "tiff", "jfif", "tif", "cr2", "dcr", "erf", "3fr", "kdc", "k25", "mos", "nef", "mef", "orf", "raw", "rw2", "pef", "srf", "sr2", "svg", "svgz", "shape", "rhif", "ani", "png", "mng", "jxl", "ora", "xjt", "xktgz", "xjtbz2", "sfw", "pwp", "cam", "jpg", "gpe", "jpeg", "j6i", "kqp", "pmp", "img", "iff", "anim", "ilbm", "lbm", "bpg", "dng", "gif", "webp" , "wbmp", "wbm", "wbp"]
    ...
    mus = ["3gp", "aa", "aac", "aax", "act", "aiff", "alac", "amr", "ape", "au", "awb", "dss", "dvf", "flac", "gsm", "iklax", "ivs", "m4a", "m4b", "m4p", "mmf", "mp3", "mpc", "msv", "nmf", "ogg", "oga", "mogg", "opus", "ra", "rm", "raw", "rf64", "sln", "tta", "voc", "vox", "wav", "wma", "wv", "cda"]
